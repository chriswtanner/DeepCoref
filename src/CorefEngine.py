...
class CorefEngine:
	if __name__ == "__main__":
		...
		stoppingPoints = [0.45,0.475,0.501,0.525] # 475 501 525
		stoppingPoints2 = [0.45,0.501,0.55,0.601,0.65,0.701,0.725,0.75,0.775,0.801,0.825,0.85] # [0.375,0.401,0.425,0.45,0.475,0.501,0.525,0.55,0.601,0.65,0.701,0.725]
