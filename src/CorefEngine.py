...
class CorefEngine:
	if __name__ == "__main__":
		...
		stoppingPoints2 = [0.701,0.801,0.901,0.925,0.95] #[0.75,0.801,0.825,0.850,0.875,0.901,0.95] # [0.375,0.401,0.425,0.45,0.475,0.501,0.525,0.55,0.601,0.65,0.701,0.725]
