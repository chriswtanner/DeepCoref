...
\multicolumn{1}{ |c| }{\# Sentences} & 7,294 & 649 & 7,867 & 15,810    \\  \hline \cline{1-5} \cline{1-5} \hline
\multicolumn{5}{|c|}{\multirow{1}{*}{Mention Length}} \\ \cline{1-5}
\multicolumn{1}{ |c| }{1 Token} & 1,938 & 386 & 2,837 & 5,161    \\ %\cline{1-5}
\multicolumn{1}{ |c| }{2 Tokens} & 142 & 52 & 240 & 434    \\ %\cline{1-5}
\multicolumn{1}{ |c| }{3 Tokens} & 18 & -- & 25 & 43    \\% \cline{1-5}
\multicolumn{1}{ |c| }{4 Tokens} & 6 & -- & 7 & 13   \\ \cline{1-5}
\end{tabular}
