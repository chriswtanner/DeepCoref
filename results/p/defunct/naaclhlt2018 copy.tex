...
\subsection{Loss}
The goal of our model is to maximize discriminability between mentions belongings to different events, while enforcing features to be as similar as possible when they are of the same class.  Contrastive Loss is perfectly suited for this objective \cite{conf/cvpr/SchroffKP15,pmlr-v48-liud16}, as shown in Equation \ref{eq:contrastive}.  As suggested by Sun, et. al. \shortcite{NIPS2014_5416}, it is crucial to carefully
